...
public class OrderIt extends AppCompatActivity implements View.OnClickListener{
    ...
    public void initDBase() {
        ...
        dbase_.insertDrink("Gedunder Holler Advent");
        dbase_.insertDrink("Beeren mix");
        dbase_.insertDrink("After eight");
        dbase_.insertDrink("Apfel-Kiwi");
        dbase_.insertDrink("Bratapfel");
        dbase_.insertDrink("Eiszapfen");
        dbase_.insertDrink("Engelchen");
        dbase_.insertDrink("Erdbeer");
        dbase_.insertDrink("Feige");
        dbase_.insertDrink("Heidelbeer");
        dbase_.insertDrink("Himbeer");
        dbase_.insertDrink("Holler");
        dbase_.insertDrink("Honig");
        dbase_.insertDrink("Kaffee");
        dbase_.insertDrink("Maroni");
        dbase_.insertDrink("Kletzerl");
        dbase_.insertDrink("Mandarinen-Rum");
        dbase_.insertDrink("Mango");
        dbase_.insertDrink("Marzipan");
        dbase_.insertDrink("Nimm 2");
        dbase_.insertDrink("Nuss");
        dbase_.insertDrink("Pfirsich-Vanille");
        dbase_.insertDrink("Preiselbeere");
        dbase_.insertDrink("Punsch");
        dbase_.insertDrink("Raffaelo");
        dbase_.insertDrink("Eierschwammerl");
        dbase_.insertDrink("Rotwein");
        dbase_.insertDrink("Sanddorn");
        dbase_.insertDrink("Johannisbeere schwarz");
        dbase_.insertDrink("Schoko-Advent");
        dbase_.insertDrink("Thymian");
        dbase_.insertDrink("Toffifee");
        dbase_.insertDrink("Weichsel");
        ...
        dbase_.insertBottle("Katze", "200ml");
        dbase_.insertBottle("Hund", "200ml");
        dbase_.insertBottle("Mond", "200ml");
        dbase_.insertBottle("Elephant", "200ml");
        dbase_.insertBottle("Schneemann", "500ml");
        dbase_.insertBottle("Doppelherz", "200ml");
        dbase_.insertBottle("Kleeblatt", "200ml");
        dbase_.insertBottle("sto", "500ml");
        dbase_.insertBottle("Glücksschein", "200ml");
        dbase_.insertBottle("Bega", "100ml");
        dbase_.insertBottle("Josy", "100ml");
        dbase_.insertBottle("Bega", "350ml");
        dbase_.insertCustomer("Barbara");
        dbase_.insertCustomer("Station");
        dbase_.insertCustomer("Yasi");
        dbase_.insertCustomer("Andrea Kraber");
    }
